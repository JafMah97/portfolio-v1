...
const dict = useTranslation().errorPage
  ...
  return (
    <div className=" relative z-50 bg-primary/20 flex min-h-[81vh] items-center justify-center px-4 py-10 md:py-20 w-full overflow-hidden">
        <HeroDecoration />
      <div className="relative z-50 max-w-3xl space-y-8 text-center w-full flex flex-col justify-center gap-5">
        ...
        <div>
          ...
          {process.env.NODE_ENV === "development" && (
            <p className="text-red-700 text-xs md:text-lg  leading-relaxed">
              {error.message}
            </p>
          )}
        </div>
