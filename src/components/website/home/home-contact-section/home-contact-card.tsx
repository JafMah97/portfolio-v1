...
import SkillCardDecoration from "../home-about-section/home-skill-card-decoration";

interface HomeContactCardProps {
  contact: {
    icon: ReactNode;
    label: string;
    link: string;
...
export default function HomeContactCard({ contact }: HomeContactCardProps) {
  return (
    <MotionWrapper
      fadeUp
      delay={0.2}
      ...
      >
        ...
        <CardContent className="p-0 relative z-20 ">
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 truncate underline text-center">
              {contact.username}
            </p>
