...
import HomeHeroStatsBar from "./home-hero-stats-bar";
import MotionWrapper from "@/components/custom/motion/motion-wrapper";
import HomeHeroDecoration from "./home-hero-decoration";

export default async function HomeHeroSection({ lang }: { lang: Lang }) {
      ...
      >
        <div className="container max-w-6xl mx-auto px-4 py-10 h-full">
          <div className="flex flex-col-reverse md:flex-row gap-6 items-center justify-end md:justify-between h-full">
            ...
            <HomeHeroImage imageAlt={dictHero.imageAlt} />
          </div>
        </div>
      </MotionWrapper>
    </section>
