...
import AboutJourneyCard from "./about-journey-card";

export default async function AboutJourneySection({ lang }: { lang: Lang }) {
  ...
  return (
    <section
      id={"journey"}
      className="py-24 relative backdrop-blur-2xl bg-primary/10 overflow-hidden "
    >
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          {experiences.map((exp, idx) => (
            <AboutJourneyCard key={idx} exp={exp} idx={idx} />
          ))}
        </div>
      </div>
    </section>
