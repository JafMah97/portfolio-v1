...
const TextType: React.FC<TextTypeProps> = ({
  ...
  const getCurrentTextColor = useCallback((): string | undefined => {
  ...
  useEffect(() => {
    ...
    const executeTypingAnimation = () => {
      if (isDeleting) {
        if (displayedText === "") {
          ...
          // small pause before next sentence starts
    ...
    // dependencies intentionally include state and callbacks used
  }, [
    currentCharIndex,
    displayedText,
    isDeleting,
